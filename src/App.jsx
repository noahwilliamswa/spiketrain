...
const THEMES = {
  ...
  "cucumber": {
    id: "cucumber",
    name: "Cucumber",
    description: "A clean light theme with soft cucumber green surfaces and fresh garden accents.",
    mode: "light",
    accent: "#4f9f6d",
    accentSoft: "rgba(79, 159, 109, 0.18)",
    page: "#eef7ef",
    panel: "#f9fff8",
    panel2: "#e1f0df",
    input: "#fbfff9",
    ...
    hover: "#d7ead4",
    menu: "#f9fff8",
    overlay: "rgba(23, 34, 24, 0.24)",
    accentText: "#ffffff",
    accentGlow: "rgba(79, 159, 109, 0.45)",
  },
  ...
  "halo-ringworld": {
    id: "halo-ringworld",
    name: "Halo Ringworld",
    description: "A cool military-sci-fi theme with UNSC steel panels, plasma blue highlights, and Forerunner-interface calm.",
    mode: "dark",
    accent: "#6ee7ff",
    accentSoft: "rgba(110, 231, 255, 0.16)",
    page: "#081018",
    panel: "#101a24",
    panel2: "#162434",
    input: "#070d13",
    ...
    accentText: "#061016",
    accentGlow: "rgba(110, 231, 255, 0.56)",
  },
  
  "skyrim-nordic": {
    id: "skyrim-nordic",
    name: "Skyrim Nordic",
    description: "A cold stone-and-snow theme with iron borders, icy blue accents, and ancient Nordic ruin atmosphere.",
    mode: "dark",
    accent: "#9fd8ff",
    accentSoft: "rgba(159, 216, 255, 0.14)",
    page: "#101317",
    panel: "#181c20",
    panel2: "#20262b",
    input: "#0b0e11",
    ...
    accentText: "#071017",
    accentGlow: "rgba(159, 216, 255, 0.48)",
  },
  
  "tron-grid": {
    id: "tron-grid",
    name: "TRON Grid",
    description: "A black glass cyber-grid theme with electric cyan lines, neon glow, and clean digital precision.",
    mode: "dark",
    accent: "#00e5ff",
    ...
    hover: "#102a33",
    menu: "#071016",
    overlay: "rgba(0, 3, 6, 0.76)",
    accentText: "#001014",
    accentGlow: "rgba(0, 229, 255, 0.68)",
  },
  
  "matrix-operator": {
    id: "matrix-operator",
    name: "Matrix Operator",
    description: "A hard black terminal theme with code-green signal glow, deep panels, and hacker-room focus.",
    mode: "dark",
    accent: "#00ff66",
    ...
    hover: "#10251a",
    menu: "#06120c",
    overlay: "rgba(0, 4, 2, 0.78)",
    accentText: "#001f0d",
    accentGlow: "rgba(0, 255, 102, 0.58)",
  },
  
  "cowboy-bebop": {
    id: "cowboy-bebop",
    name: "Cowboy Bebop",
    description: "A smoky space-jazz theme with navy panels, golden brass accents, warm red hints, and retro bounty-board style.",
    mode: "dark",
    accent: "#f2b84b",
    accentSoft: "rgba(242, 184, 75, 0.17)",
    page: "#0b1018",
    panel: "#121926",
    panel2: "#1a2433",
    input: "#080c12",
    ...
    accentText: "#211407",
    accentGlow: "rgba(242, 184, 75, 0.52)",
  },
  
  "evangelion-command": {
    id: "evangelion-command",
    name: "Evangelion Command",
    description: "A high-alert command-center theme with deep purple panels, orange warnings, and green data signals.",
    mode: "dark",
    accent: "#ff8c1a",
    accentSoft: "rgba(255, 140, 26, 0.18)",
    page: "#100b18",
    panel: "#1a1226",
    panel2: "#241833",
    input: "#0c0812",
    ...
    hover: "#302040",
    menu: "#1c1428",
    overlay: "rgba(6, 3, 10, 0.70)",
    accentText: "#160a00",
    accentGlow: "rgba(255, 140, 26, 0.62)",
  },
