...
const THEMES = {
  ...
  "signal-orange": {
    id: "signal-orange",
    name: "Signal Orange",
    description: "A focused dark theme with charcoal panels and sharp amber-orange signal accents.",
    mode: "dark",
    accent: "#ff9f43",
    accentSoft: "rgba(255, 159, 67, 0.16)",
    page: "#11110f",
    panel: "#1b1a16",
    panel2: "#242219",
    input: "#12110e",
    ...
    accentText: "#11110f",
    accentGlow: "rgba(255, 159, 67, 0.55)",
  },
};
