...
const THEMES = {
  ...
  "blade-runner-terminal": {
    ...
    description: "A rainy cyberpunk dark theme with neon cyan, magenta edges, and late-night terminal contrast.",
    mode: "dark",
    accent: "#32f6ff",
    accentSoft: "rgba(50, 246, 255, 0.16)",
    page: "#080c13",
    panel: "#101722",
    panel2: "#151f2e",
    input: "#070a10",
    ...
    accentText: "#061014",
    accentGlow: "rgba(50, 246, 255, 0.62)",
  },
  ...
  "twin-peaks-red-room": {
    id: "twin-peaks-red-room",
    name: "Twin Peaks Red Room",
    description: "A surreal dark lounge theme with velvet reds, black panels, cream text, and warm mystery.",
    mode: "dark",
    accent: "#c1121f",
    accentSoft: "rgba(193, 18, 31, 0.20)",
    page: "#100707",
    panel: "#190b0b",
    panel2: "#240f0f",
    input: "#0b0505",
    ...
    hover: "#2d1515",
    menu: "#1c0d0d",
    overlay: "rgba(5, 0, 0, 0.70)",
    accentText: "#fff1d6",
    accentGlow: "rgba(193, 18, 31, 0.58)",
  },
